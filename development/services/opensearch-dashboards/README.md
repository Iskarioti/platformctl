...
This directory is the canonical configuration package for the `opensearch-dashboards` local development service.
...
`~/.config/workstation/services/opensearch-dashboards.env`.
