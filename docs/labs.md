...
- `rag-pipeline` — Ollama + Qdrant RAG retrieval pipeline; smoke,
  Qdrant-outage, and answer-quality (golden Q&A set + LLM-judge score, gated
  on a threshold) tests. See `docs/ai-workstation.md`.
