...
defense - a real, working starting point for the risks README's "Threat
model" section documents: content this agent reads that it didn't generate
itself (a future tool's return value, a fetched page) can carry injection
attempts, and model output shouldn't carry obvious PII back to a caller
either.
"""
