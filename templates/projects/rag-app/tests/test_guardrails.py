...
def test_no_flags_on_clean_text_when_enabled(monkeypatch) -> None:
    monkeypatch.setenv("GUARDRAILS_ENABLED", "true")
    assert guardrails.flag_prompt_injection("platformctl validates architecture before production.") == []
